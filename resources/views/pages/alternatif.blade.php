                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="row">
                                        ...
                                        <div class="d-flex mr-1 mb-1">
                                            <a href="/add_detail_alternatif/{{$item->id}}" class="btn-md btn btn-success"    data-toggle="tooltip" data-placement="top" title="List Detail"><i class="uil-list-ul"></i></a>               
                                        </div>
                                    </td>
                                </tr>
                            @empty
